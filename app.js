...
const demoCases = [
  {
    ...
    photo: "TRAVEL\nORGANIZER",
    photoSrc: "./images/case-travel-bag.jpg",
    ...
    listing: {
      main: "./images/listing-main-real.jpg",
      alt: "真实设备装入与尺寸实测产品图",
      badge: "设备装入\n尺寸实测",
  ...
  },
  {
    ...
    photo: "CAMP\nTABLE",
    photoSrc: "./images/case-camp-table.jpg",
    ...
    listing: {
      main: "./images/listing-main-camp-table.jpg",
      alt: "折叠露营桌承重与收纳产品图",
      badge: "承重展示\n折叠尺寸",
  ...
  },
  {
    ...
    photo: "SLOW\nBOWL",
    photoSrc: "./images/case-slow-bowl.jpg",
    ...
    listing: {
      main: "./images/listing-main-slow-bowl.jpg",
      alt: "浅槽易清洗慢食碗产品图",
      badge: "浅槽可达\n可拆洗",
