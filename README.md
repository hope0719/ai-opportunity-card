...
**备用在线版本**（内置离线模式，防演示失败）：
👉 **https://ai-product-opportunity-card.app.workbuddy.host/**
...
本项目为**生财深圳跨境电商黑客松参赛作品，荣获亚军**。从早期「差评炼金」评论分析迭代为「AI 选品机会卡」选品决策工作台，经多轮路演与投票晋级（16 强 → 决赛），最终夺得亚军。演示版（GitHub Pages 静态站）与备用在线版（内置离线模式）见文首链接。
